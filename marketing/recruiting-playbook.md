...
Reusable recruiting strategy and source copy for `VBP Fantasy Network`.
...
- title angles
- platform guidance
- labeled source-copy templates

Use `marketing/recruiting-copy-ready.txt` for:
- plain-text posts
...
- `Facebook`
  - Best for short direct posts and division-by-division recruiting.
- `Reddit`
...
When to use:
- one-link post
- slow bracket division

```text
Foundry is one of the open Dynasty Bracket startup divisions in the VBP Fantasy Network right now.

This is the slow-draft division in a $50 per season Superflex dynasty setup with 3 FLEX, 4 taxi, 4 IR, a 3RR startup draft, and one shared playoff structure across the full format. Startup cost is $150 up front to keep the league stable and future-pick trading protected.
...
```text
Forge is one of the open Dynasty Bracket startup divisions in the VBP Fantasy Network right now.
...
When to use:
- one-link post
- fast bracket division

```text
Legacy is one of the open Dynasty Bracket startup divisions in the VBP Fantasy Network right now.

This is the fast-draft division in a $50 per season Superflex dynasty setup with 3 FLEX, 4 taxi, 4 IR, a 3RR startup draft, and one shared playoff structure across the full format. Startup cost is $150 up front to keep the league stable and future-pick trading protected.
...
```text
Empire is one of the open Dynasty Bracket startup divisions in the VBP Fantasy Network right now.
