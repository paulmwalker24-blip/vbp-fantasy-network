...
$validFormats = @("redraft", "redraft32", "comanager", "dynasty", "dynastybracket", "bestball", "gauntlet", "bracket", "keeper", "pickem", "chopped")
...
$expectedConstitutionPageByFormat = @{
  ...
  redraft32 = "32-team-redraft-constitution.html"
